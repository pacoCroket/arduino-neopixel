...
void ChangePaletteAndSettingsPeriodically()
{
  ...
  if( lastSecond != secondHand) {
    ...
    if( secondHand == 0)  { currentPalette = LavaColors_p;            speed =  8 * speedFactor; scale = 8 * scaleFactor; colorLoop = 0; }
...
//    if( secondHand == 20)  { currentPalette = CloudColors_p;           speed =  8 * speedFactor; scale = 8 * scaleFactor; colorLoop = 0; }
